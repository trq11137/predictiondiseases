...
Pregnency_model = pickle.load(open('Pregnancy_disease_model.sav', 'rb'))
...
if (selected == 'Pregnancy Risk Prediction'):
    ...
    if st.button('Pregnancy Test Results'):
        ...
        elif (Pregnency_prediction[0] == 2):
            Pregnency_diagnosis = 'mid risk'
        else:
            Pregnency_diagnosis = 'The Person Low risk'
